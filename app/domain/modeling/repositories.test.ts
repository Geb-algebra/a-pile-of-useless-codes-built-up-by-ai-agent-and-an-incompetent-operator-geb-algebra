...
describe("CommandRepository", () => {
  ...
  it("should clear all commands", async () => {
    const command1 = CommandFactory.create("CreateUser", "Creates a new user", EventFactory.create("UserCreated"));
    const command2 = CommandFactory.create("UpdateUser", "Updates a user's information", EventFactory.create("UserUpdated"));
...
describe("UbiquitousLanguageRepository", () => {
  ...
  it("should delete a term", async () => {
    const term = UbiquitousLanguageFactory.create("Aggregate");
    await UbiquitousLanguageRepository.save(term, "A cluster of domain objects that can be treated as a single unit");
  ...
  it("should clear all terms", async () => {
    ...
    await UbiquitousLanguageRepository.save(term1, "A cluster of domain objects that can be treated as a single unit");
    await UbiquitousLanguageRepository.save(term2, "An object defined by its identity rather than its attributes");
