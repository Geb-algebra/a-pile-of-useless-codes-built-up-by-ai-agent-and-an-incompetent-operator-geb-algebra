...
export class EntityFactory {
	static create(name: string, properties: Record<string, ValueObject> = {}): Entity {
		return {
...
export class ValueObjectFactory {
	static create(name: string, value: string | null = null): ValueObject {
		return {
...
export class CommandFactory {
	static create(name: string, description, triggeredEvent: Event): Command {
		return {
